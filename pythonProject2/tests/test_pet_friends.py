...
def test_add_pets_with_valid_data(name='Barsik', animal_type='cat', age='5', pet_photo='images/animal.jpg'):
...
def test_delete_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pets(api_key, 'Barsik', 'cat', '5', 'images/animal.jpg')
        _, my_pets = pf.get_list_of_pets(api_key, 'my_pets')
...
def test_add_pets_with_valid_data_without_photo(name='БарсикБезФото', animal_type='кот', age='6'):
...
def test_add_photo_at_pet(pet_photo='images/siamka.jpg'):
...
def test_add_pet_negative_age_number(name='Barsik', animal_type='cat', age='-3', pet_photo='images/animal.jpg'):
...
def test_add_pet_with_four_digit_age_number(name='Barsik', animal_type='cat', age='1234', pet_photo='images/animal.jpg'):
...
def test_add_pet_with_empty_value_in_variable_name(name='', animal_type='cat', age='2', pet_photo='images/animal.jpg'):
...
def test_add_pet_with_a_lot_of_words_in_variable_name(animal_type='cat', age='2', pet_photo='images/animal.jpg'):
...
def test_add_pet_with_special_characters_in_variable_animal_type(name='Barsik', age='3', pet_photo='images/animal.jpg'):
...
def test_add_pet_with_numbers_in_variable_animal_type(name='Kotik', animal_type='34562', age='3',
                                                      pet_photo='images/animal.jpg'):
    ...
    assert status == 200
    assert animal_type not in result['animal_type'], 'Питомец добавлен на сайт с цифрами вместо букв в поле породы'


def test_add_pet_with_a_lot_of_words_in_variable_animal_type(name='Pupsik', age='2', pet_photo='images/animal.jpg'):
    ...
    animal_type = 'миттельшнауцер ньюфаундленд'
